    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="bg-white shadow-md sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center">
            <svg className="h-8 w-8 text-indigo-600" viewBox="0 0 24 24" stroke="currentColor" fill="none">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <div className="ml-4">
              <h1 className="text-xl font-bold text-gray-900">PDF Chat Assistant</h1>
              <p className="text-sm text-gray-600">Analyze legal documents with AI</p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                {currentSession && (
                  <>
                    ...
                    />
                    <div className="mt-6">
                      <h3 className="text-md font-semibold text-gray-900 mb-2">Documents</h3>
                      <div className="space-y-2 max-h-48 overflow-y-auto">
                        {uploadedPdfs.length > 0 ? (
                          uploadedPdfs.map((pdf, index) => (
                            ...
                            >
                              <svg className="h-5 w-5 text-gray-500 mr-2" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                              </svg>
                              <span className="text-sm text-gray-700 truncate">{pdf}</span>
                            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 h-full flex flex-col">
              ...
              {currentSession ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center bg-gray-50 rounded-lg p-6 text-center">
                  <svg className="h-12 w-12 text-gray-400 mb-4" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                  </svg>
                  <p className="text-gray-600 mb-4">Start by creating or selecting a session</p>
                  <button
                    onClick={createNewSession}
                    disabled={isLoading}
