...
import { fetchUsers, addUser, removeUser, filterUsers } from "../../redux/slices/abrassio/usersSlice";
...
const Users = () => {
  ...
  const handleAddUser = () => {
    dispatch(addUser(newUser)).then((result) => {
  ...
  const handleRemoveUser = () => {
    ...
    dispatch(removeUser(selectedUser._id)).then(() => {
      setShowModal(false);
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 flex flex-col py-12 px-6 relative">
      ...
      <div className="w-full max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-lg text-gray-600">Manage all users here</p>
        </div>
