...
const TikTokScraper = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8">
      <h2 className="text-4xl text-center text-purple-800 font-bold mb-8">TikTok Scraper</h2>
      ...
      {posts.length > 0 && (
        <div className="w-full max-w-6xl mt-10 p-4 bg-white border-2 border-gray-200 rounded-lg shadow-inner">
          <h3 className="text-xl font-semibold mb-4 text-center text-purple-800">Scraped TikTok Data</h3>
              ...
              <thead>
                <tr className="bg-gray-100 text-purple-800 font-bold text-center">
                  {tableHeaders.map((header, index) => (
                    <th key={index} className="border p-2 whitespace-nowrap">{header}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
